  ...
  return (
    ...
    >
      <div
        ...
        style={{
          perspective: "1000px",
          height: "auto", // Allow the container to adapt its height
        }}
      >
...
const Card = ({ rotate, scale, children }) => (
  <motion.div
    ...
    className="max-w-5xl -mt-12 mx-auto w-full border-4 border-[#6C6C6C] p-2 md:p-2 bg-[#222222] rounded-[30px] shadow-2xl"
  >
